...
public class foodOrderFragment extends Fragment {
    ...
    private foodOrderFragment.OnFragmentInteractionListener mListener;
    View view;
    ...
    public static foodOrderFragment newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt("argsInstance", instance);
        foodOrderFragment foodOrderFragment = new foodOrderFragment();
        foodOrderFragment.setArguments(args);
