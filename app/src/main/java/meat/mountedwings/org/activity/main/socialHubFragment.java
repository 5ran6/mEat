...
public class socialHubFragment extends Fragment {
    public socialHubFragment() {
        // Required empty public constructor
    }

    private socialHubFragment.OnFragmentInteractionListener mListener;

    View view;



    public static socialHubFragment newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt("argsInstance", instance);
        socialHubFragment socialHubFragment = new socialHubFragment();
        socialHubFragment.setArguments(args);
